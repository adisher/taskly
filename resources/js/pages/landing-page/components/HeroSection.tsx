...
export default function HeroSection({ settings, sectionData, brandColor = '#3b82f6' }: HeroSectionProps) {
  ...
  return (
    <section id="hero" className="relative pt-16 bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100 min-h-screen flex items-center overflow-hidden">
      {/* Background Pattern */}
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left space-y-6 sm:space-y-8">
            {sectionData.announcement_text && (
              <div className="inline-flex items-center px-4 py-2 bg-white/80 backdrop-blur-sm text-gray-700 rounded-full text-sm font-medium border border-gray-200 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
              ...
              <Link
                href={route('login')}
                className="bg-white border-2 px-8 py-4 rounded-xl transition-all duration-300 font-semibold text-base flex items-center justify-center gap-2 hover:bg-gray-50 hover:scale-105 transform shadow-sm"
