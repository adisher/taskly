...
class LandingPageSetting extends Model
{
    ...
    {
        $settings = self::first();
        $app_name = config('is_saas', false) == true ? 'Taskly SaaS' : 'Taskly';            
        ...
        if (!$settings) {
            ...
            $defaultConfig = [
                'sections' => [
                    ...
                    [
                        ...
                        'screenshots_list' => [
                            [
                                'src' => '/storage/media/5/q-taskly-saas-pic.png',
                                'alt' => 'Workspace Management',
                                'title' => 'Workspace Management',
                                'description' => '; multiple workspaces with role-based permissions, team member invitations, and customizable workspace settings for different projects and departments'
                            ],
                            [
                                'src' => '/storage/media/6/r-taskly-saas-pic.png',
                                'alt' => 'Project Dashboard',
                                'title' => 'Project Dashboard',
                                'description' => 'Comprehensive project overview with real-time progress tracking, milestone management, team performance metrics, and interactive charts for project analytics'
                            ],
                            [
                                'src' => '/storage/media/7/s-taskly-saas-pic.png',
                                'alt' => 'Task Management',
                                'title' => 'Task Management',
                                'description' => 'Advanced task management with Kanban boards, priority levels, due dates, task dependencies, file attachments, and collaborative comments for seamless team coordination'
                            ],
                            [
                                'src' => '/storage/media/16/ab-taskly-saas-pic.png',
                                'alt' => 'Budget Management',
                                'title' => 'Budget Management',
                                'description' => 'Complete financial oversight with budget allocation, expense tracking, cost analysis, budget vs actual reporting, and automated alerts for budget thresholds'
                            ],
                            [
                                'src' => '/storage/media/21/ag-taskly-saas-pic.png',
                                'alt' => 'Invoice Management',
                                'title' => 'Invoice Management',
                                'description' => 'Professional invoice creation with customizable templates, automated billing cycles, payment tracking, client management, and integration with popular payment gateways'
                            ],
                            [
                                'src' => '/storage/media/11/w-taskly-saas-pic.png',
                                'alt' => 'Time Tracker App',
                                'title' => 'Time Tracking',
                                'description' => 'Comprehensive time tracking with start/stop timers, manual time entry, project-based time logging, detailed timesheets, and productivity analytics accessible from any device'
                            ]
                        ]
                    ],
                    [
            ...
            $settings = self::create([
                ...
                'contact_email' => 'info@taskly.com',
                'contact_phone' => '+1 (555) 123-4567',
                'contact_address' => '123 Main Street, Suite 100, San Francisco, CA 94105',
